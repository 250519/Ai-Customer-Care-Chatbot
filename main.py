...
# from langchain.schema import Document, HumanMessage, AIMessageChunk
...
class CustomerServiceBot:
    def __init__(self, pdf_path: str):
        ...
        self.google_api_key = "AIzaSyDYvfMX-qZgtTZC6VXYECu21fnqfQ5HuiY"
        ...
        self.PROMPT = PromptTemplate(
            template="""You are a knowledgeable customer care AI assistant for Safeguard Realty, a Digital Asset Platform focusing on real estate tokenization. Use the following context to answer questions about the company, its services, team, and offerings. Be specific and use details from the context when available.
                    ...
                    2. Provide detailed answers using the context.
                    3. Reference specific data points and figures when available.
                    4. Maintain a professional and informative tone.
                    5. For technical questions, use explanations from the context.
                    6. Discuss financials or market size using the context figures.
...
async def run_chat_interface():
    ...
    print("\n=== Welcome to Safeguard Realty Customer Service AI ===")
